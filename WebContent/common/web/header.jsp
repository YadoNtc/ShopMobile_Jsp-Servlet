			...
			<div class="span3">
				<div class="pull-right">
					<c:if test="${not empty USERMODEL }">
						<a href="#"> <span
						class="btn btn-mini btn-primary">Xin chào, ${USERMODEL.fullName}</span>
						</a> 
						<a href="<c:url value="/thoat?action=logout"/>"> <span
						class="btn btn-mini btn-primary"> Thoát </span>
						</a>
					</c:if>
					
					<c:if test="${empty USERMODEL }">
						<a href="<c:url value="/dang-nhap?action=login"/>"> <span
		...
		<div id="logoArea" class="navbar">
			...
			<div class="navbar-inner">
				<a class="brand" href="<c:url value="/trang-chu"/>"><img
					src="/Project1/template/images/logontc.png" alt="Bootsshop"
					style="height: 50px;"></a>
				...
				<ul id="topMenu" class="nav pull-right">
					...
					<li class=""><a href="<c:url value="gio-hang"/>">
						...
						<img src="/Project1/template/images/ico-cart.png" alt="cart"></a>
					</li>
	...
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
			<div class="item active">
				<div class="container">
					<a href="#"><img
						...
						src="/Project1/template/images/slide_3_F-C1_1200x300.jpg"
			...
			<div class="item">
				<div class="container">
					<a><img style="width: 100%; height: 340px"
						src="/Project1/template/images/slide_1_1200x300.jpg"
						alt=""></a>
				</div>
				<br> <br>
			</div>
			...
			<div class="item">
				<div class="container">
					<a><img style="width: 100%; height: 340px"
						src="/Project1/template/images/slide_2_1200x300.jpg" alt=""></a>
				</div>
				<br> <br>
			</div>
			...
			<div class="item">
				<div class="container">
					<a><img style="width: 100%; height: 340px"
						src="/Project1/template/images/slide_4_F-C1_1200x300@2x.jpg" alt=""></a>
				</div>
				<br> <br>
			</div>
			...
			<div class="item">
				<div class="container">
					<a><img style="width: 100%; height: 340px"
						src="/Project1/template/images/slide_5_F-C1_1200x300.jpg"
						alt=""></a>
				</div>
				<br> <br>
			</div>
			...
			<div class="item">
				<div class="container">
					<a><img style="width: 100%; height: 340px"
						src="/Project1/template/images/slide_6_F-C1_1200x300.jpg"
						alt=""></a>
				</div>
				<br> <br>
			</div>
